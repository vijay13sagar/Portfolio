...
const Nav = () => {
    ...
    return (
        <div className='cont'>
            <NavBar Dark={isDark}>
                <div className='hor'>
                    <MyName Dark={isDark}>Vizia Vidya Sagar <SurName Dark={isDark}>Kasina</SurName></MyName>
                    ...
                    <List>
                        <div className='hornav'>
                            <NavLink to='/' className={({ isActive }) => (isActive & isDark ? 'activeDark Dark' : isActive & !isDark ? 'activeLight light' : isDark ? 'Dark' : 'light')}>
                                <ListItem><NavItem Dark={isDark}>Home</NavItem></ListItem>
                            </NavLink>
                            <NavLink to='/Skills' className={({ isActive }) => (isActive & isDark ? 'activeDark Dark' : isActive & !isDark ? 'activeLight light' : isDark ? 'Dark' : 'light')}>
                                <ListItem><NavItem Dark={isDark}>My Skills</NavItem></ListItem>
                            </NavLink>
                            <NavLink to='/Contact' className={({ isActive }) => (isActive & isDark ? 'activeDark Dark' : isActive & !isDark ? 'activeLight light' : isDark ? 'Dark' : 'light')}>
